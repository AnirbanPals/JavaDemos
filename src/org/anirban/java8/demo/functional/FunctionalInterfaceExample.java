...
@FunctionalInterface  
interface SimpleAddInterface  // note similarity in name to the previous AddInterface - so name changed
{  
    void add(int a, int b);  
 
    //It can contain any number of Object class methods which it MAY OPTIONALLY override.  
    int hashCode();  
    String toString();  
    boolean equals(Object obj);  
}  
 
public class FunctionalInterfaceExample implements SimpleAddInterface 
{
